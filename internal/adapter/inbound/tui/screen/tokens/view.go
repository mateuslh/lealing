...
func (m *Model) viewEmpty(th *theme.Theme, f tui.Frame) string {
...
func (m *Model) viewKPIs(th *theme.Theme, width int) string {
...
func (k kpi) render(th *theme.Theme, width int) string {
...
func (m *Model) viewDaily(th *theme.Theme, width, height int) string {
	days := m.report.ByDay
	if len(days) == 0 {
...
func (m *Model) viewBreakdown(th *theme.Theme, width, height int) string {
...
func (m *Model) toneFor(th *theme.Theme, s coretokens.Slice) lipgloss.TerminalColor {
	switch m.breakdown {
	case byProvider:
